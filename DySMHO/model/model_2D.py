...
#             print(std2)
    ...
    '''
    def pre_processing_2(self, verbose = True, plot = False, significance = 0.9, confidence = 1-1e-8 ): 
        ...
        for i in self.all_features_y1: 
            if i not in ['dy_dt','y_shift']: 
                ...
                if (i in self.columns_to_keep1):
                    if (results1.pvalues[count]) < p_val_tolerance or i in ['1','y0','y1']: 
        ...
        for i in self.all_features_y2: 
            if i not in ['dy_dt','y_shift']: 
                all_features_sym.append(i)
                if (i in self.columns_to_keep2):
                    if (results2.pvalues[count]) < p_val_tolerance or i in ['1','y0','y1']: 
